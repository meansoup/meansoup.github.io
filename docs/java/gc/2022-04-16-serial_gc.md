...
[STW](/docs/java/gc/basic#stw-stop-the-world)가 긴 편이므로 STW가 상관없는 환경에서 사용된다.
...
young 영역에서는 앞서 설명한 [Generational Process](/docs/java/gc/basic#generational-process)에 따라 GC를 수행한다.  
