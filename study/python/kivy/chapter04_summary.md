...
ScreenManager는 여러 device에서 screen을 적절하게 조절할 수 있게 해줌.  
multiple screen을 갖도록 해주며 screen간 switch를 쉽게 해줌.
...
**[transision](https://kivy.org/doc/stable/api-kivy.uix.screenmanager.html#changing-transitions)**: screen을 switch 할 때 어떤 animation이 보이는가에 대한 것.
